          ...
          <ScrollView contentContainerStyle={styles.modalScroll} showsVerticalScrollIndicator={false}>
            {selectedItem && (
              <>
                ...
                <StatusCard title="Food Safety" data={formatData(selectedItem.analysis.food)} icon="food-apple" isLocked={false} />
                <StatusCard title="Skin Safety" data={formatData(selectedItem.analysis.skin)} icon="face-man-shimmer" isLocked={false} />
                <StatusCard title="Makeup Safety" data={formatData(selectedItem.analysis.makeup)} icon="lipstick" isLocked={!isPro} />
                <StatusCard title="Vegetarian" data={formatData(selectedItem.analysis.veg || selectedItem.analysis.vegetarian)} icon="leaf" isLocked={!isPro} />
                <StatusCard title="Vegan" data={formatData(selectedItem.analysis.vegan)} icon="sprout" isLocked={!isPro} />
                <StatusCard title="Halal" data={formatData(selectedItem.analysis.halal)} icon="star-crescent" isLocked={!isPro} />
                <StatusCard title="Alcohol Free" data={formatData(selectedItem.analysis.alcohol)} icon="glass-cocktail-off" isLocked={!isPro} />
              </>
            )}
          </ScrollView>
        </View>
